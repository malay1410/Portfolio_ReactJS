  ...
  return (
    <section id="personal-projects" className="min-h-screen py-20">
      ...
      <div className="max-w-5xl mx-auto px-4">
        <h2 className="text-3xl font-bold mb-8 bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-center">
          {" "}
          Personal Projects
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-4! hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.6)]! transition">
              ...
              <p className="text-gray-400 text-sm mb-4">
                ...
                With modern encryption and token-based access, SendSwift ensures
                safe, seamless communication—ideal for teams, freelancers, and
          ...
          >
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-4! hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.6)]! transition">
              ...
              <p className="text-gray-400 text-sm mb-4">
                ...
                eliminating middlemen, with a user-friendly interface and secure
                blockchain-based decentralized transactions for privacy.
              </p>
          ...
          >
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-4! hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.6)]! transition">
              ...
              <p className="text-gray-400 text-sm mb-4">
                Developed an advanced Library Management System using Red-Black
                trees and Binary Min-Heaps, optimizing book reservations and
                enhancing efficiency in large-scale institutions. Implemented
                innovative features and visualizations.
              </p>
          ...
          >
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-4! hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.6)]! transition">
              ...
              <p className="text-gray-400 text-sm mb-4">
                Developed a blockchain-based system for comprehensive candidate
                validation, automating data collection and verification.
                Enhanced recruitment process reliability and employer confidence
                through secure, tamper-proof record-keeping.
              </p>
          ...
          >
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-4! hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.6)]! transition">
              ...
              <h3 className="text-xl font-bold mb-2">Black Jack with PixiJS</h3>
              <p className="text-gray-400 text-sm mb-4">
                A dynamic Blackjack game built with PixiJS, offering role-based
                gameplay and customizable bet settings. Featuring smooth
                animations and an engaging user interface for immersive gaming.
              </p>
          ...
          >
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-4! hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.6)]! transition">
              ...
              <h3 className="text-xl font-bold mb-2">Chat App using Flutter</h3>
              <p className="text-gray-400 text-sm mb-4">
